...
# Based on the working container pattern with union types
...
module Terminal
  ...
  # Union type for all supported service types
  # This needs to include all types that will be registered
  # Note: Test classes are defined in spec files
  alias ServiceType = String | Int32 | Float64 | Bool
  ...
  class ServiceRegistration
    ...
    getter factory : Proc(ServiceInstance)
