...
puts "• crystal run examples/interactive_builder_demo.cr - Builder-based interactive chat demo"
puts "• Demonstrates Enter submission, `/quit`, and Escape key handling"
